...
const EXHIBITOR_PACKAGES = [
  {
    ...
    features: [
      ...
      { label: "Interview", value: "10 minute premium brand interview (done by host)" },
      { label: "Furniture", value: "Five (5) chairs, Two (2) 6ft tables" },
      { label: "Branding", value: "All event promotional materials, digital ads and banners, event backdrop" },
      { label: "Media Exposure", value: "Multiple Instagram stories and posts, On-stage brand mention (opening or peak hour)" },
    ]
  },
  {
    name: "Gold Package",
    ...
    features: [
      ...
      { label: "Interview", value: "5 minute brand interview (done by the host)" },
      { label: "Furniture", value: "Two (2) chairs, One (1) 6ft table" },
      { label: "Branding", value: "Event flyers and digital promotions" },
